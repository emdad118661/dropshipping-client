...
const NewArrival = () => {
  return (
    <div className='mx-auto mt-20 max-w-7xl'>
      <HeadSubhead title="New Arrival" subtitle="Shop the latest products online in Bangladesh — New Arrivals Daily"></HeadSubhead>
      <div className='grid grid-cols-1 gap-5 mx-16 mt-10 md:grid-cols-2 lg:grid-cols-4 md:mx-0'>
        <Card
